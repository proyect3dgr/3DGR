  ...
  render() {
    return (
      <form onSubmit={this.handleFormSubmit}>
        <input name="title" placeholder="title" value={this.state.title} onChange={e => this.handleChange(e)}/>
        <input name="price" placeholder="price" value={this.state.price} onChange={e => this.handleChange(e)}/>
        <textarea name="description" placeholder="description" value={this.state.description} onChange={e => this.handleChange(e)}/>
